...
node {
    ...
    stage('build and create docker image'){
        sh "./mvnw clean com.github.eirslett:frontend-maven-plugin:yarn -Dfrontend.yarn.arguments=webpack:prod:main package -Pdev jib:dockerBuild  -Dmaven.test.skip=true"
    }
